    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMais.setOnClickListener(v -> {
            ...
            if (input1.isEmpty() || input2.isEmpty()) {
                Toast.makeText(getApplicationContext(), "Digite dois números para a soma", Toast.LENGTH_SHORT).show();
            }
        ...
        btnMenos.setOnClickListener(v -> {
            ...
            if (input1.isEmpty() || input2.isEmpty()) {
                Toast.makeText(getApplicationContext(), "Digite dois para a subtração", Toast.LENGTH_SHORT).show();
            }
        ...
        btnDiv.setOnClickListener(v -> {
            ...
            if (input1.isEmpty() || input2.isEmpty()) {
                Toast.makeText(getApplicationContext(), "Digite dois números para a divisão", Toast.LENGTH_SHORT).show();
            }
        ...
        btnMulti.setOnClickListener(v -> {
            ...
            if (input1.isEmpty() || input2.isEmpty()) {
                Toast.makeText(getApplicationContext(), "Digite dois para a multiplicação", Toast.LENGTH_SHORT).show();
            }
